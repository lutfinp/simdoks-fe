...
const FormLogin = ({onLogin}) => {
    ...
    <div className="flex h-screen">
        <div className="flex-1 bg-cover bg-center h-screen flex items-center justify-center" style={{backgroundImage: "url('/assets/Login.jpg')"}}>
            <div className="absolute left-4 bottom-4" style={{zIndex:2}}>
                <img src={imagePathAsset} alt="asset_login" className="w-72 h-auto" />
            </div>
            <div className="w-full max-w-xl p-20 bg-white bg-opacity-30 rounded-l-[30px] shadow-md" style={{zIndex:3}}>       
                <h1 className="text-2xl font-bold mb-4 text-white mt-14">Selamat Datang</h1>
                    <p className="text-sm text-white mb-10">Masukan username dan password anda untuk login</p>   
                        <form onSubmit={Auth}>
                            ...
                            <button type="submit" className="w-full p-2 bg-blue-500 text-white rounded-md mb-16 hover:bg-white hover:text-black">
                                Masuk
                            </button>
                        </form>
            </div>
