    ...
    <div className="flex flex-row gap-2">
      ...
      <div className="w-full bg-gray-50">
        <div className="ml-[32px] mr-[32px] my-4 flex flex-col gap-3">
          <section>
            <div>
            <NavCategory judul={folsubprogram.data} id={id} subid={subid} searchfile="Program" api="program" direct="program" add={true}/>
            </div>
          </section>
          <div className="pt-2">
            <ListFile data={file.data} subid={subid} id={id} handleFileClick={handleFileClick} fileUrl={fileUrl} api="program" fileID={selectedFileId} />
          </div>
        </div>
      </div>
    </div>
